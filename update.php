  ...
  <body>
    <div class="container">
        ...
        <div class="card shadow bg-tertiary rounded mb-4 ">
            <div class="card-body">
                <form class="d-flex" action="update_dua.php" method="post">
                    <input type="text" class="form-control me-2" name="title_note" placeholder="<?php echo $result['title_note']?>">
                    <input type="text" class="form-control me-2" name="note_note" placeholder="<?php echo $result['note_note']?>">
                    <input type="hidden" name="id" class="form-control me-2" name="note_note" value="<?php echo $result['id_note']?>">
